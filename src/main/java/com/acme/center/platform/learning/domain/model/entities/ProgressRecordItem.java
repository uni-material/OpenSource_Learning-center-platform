...
//elementos persistentes en Auditable Model
@Getter
@Entity
public class ProgressRecordItem extends AuditableModel {
    ...
    //regla de negocio -> días transcurridos
    public long calculateDaysElapsed(){
        ...
        var toDate = this.completedAt == null ? LocalDate.now().atStartOfDay(defaultTimeZone).toInstant()
